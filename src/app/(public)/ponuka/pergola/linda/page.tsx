...
const Page = () => {
  return (
    <DetailOfferPage
      heroImage="/images/pergola/linda.png"
      title="Pergola Linda"
      column1={{
      ...
      iframeUrl="https://app.sketchup.com/viewer/3dw?WarehouseModelId=ca53e3f8-73d0-4586-a2f9-21b873f64da3"

      illustrationImages={["/images/pergola/linda-2.png", "/images/pergola/linda-3.png"]}
    />
  )
}
